...
static emlrtRTEInfo ic_emlrtRTEI = { 24,/* lineNo */
  34,                                  /* colNo */
  "mark_diviner_testpoints",           /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mark_diviner_testpoints"
  ".m"                                 /* pName */
...
static emlrtRTEInfo tc_emlrtRTEI = { 40,/* lineNo */
  5,                                   /* colNo */
  "mark_diviner_testpoints",           /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mark_diviner_testpoints"
  ".m"                                 /* pName */
...
static emlrtRTEInfo uc_emlrtRTEI = { 43,/* lineNo */
  9,                                   /* colNo */
  "mark_diviner_testpoints",           /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mark_diviner_testpoints"
  ".m"                                 /* pName */
...
static emlrtRTEInfo vc_emlrtRTEI = { 47,/* lineNo */
  57,                                  /* colNo */
  "mark_diviner_testpoints",           /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mark_diviner_testpoints"
  ".m"                                 /* pName */
  ...
  *sample_surface_temperatures)
{
  ...
  emxEnsureCapacity_cell_wrap_0(sp, sample_timepoints, i, &ic_emlrtRTEI);
  ...
  emxInit_real_T(sp, &min_jd_repl, 2, &rc_emlrtRTEI, true);
  emxInit_real_T(sp, &max_jd_repl, 2, &sc_emlrtRTEI, true);
  ...
  i = lat_arr->size[1];
  emxInit_real_T(sp, &lat_repl, 2, &tc_emlrtRTEI, true);
  emxInit_real_T(sp, &long_repl, 2, &uc_emlrtRTEI, true);
  emxInit_boolean_T(sp, &r, 2, &oc_emlrtRTEI, true);
  emxInit_boolean_T(sp, &r1, 2, &oc_emlrtRTEI, true);
  emxInit_int32_T(sp, &r2, 2, &vc_emlrtRTEI, true);
  emxInit_int32_T(sp, &r3, 2, &wc_emlrtRTEI, true);
  emxInit_int32_T(sp, &r4, 2, &wc_emlrtRTEI, true);
  emxInit_int32_T(sp, &r5, 2, &vc_emlrtRTEI, true);
  for (lat_idx = 0; lat_idx < i; lat_idx++) {
    ...
    for (long_idx = 0; long_idx < i1; long_idx++) {
      ...
      emxEnsureCapacity_boolean_T(sp, r, i2, &kc_emlrtRTEI);
      ...
      r->size[0] = 1;
      emxEnsureCapacity_boolean_T(sp, r, end, &kc_emlrtRTEI);
      loop_ub = i2 - 1;
      for (i2 = 0; i2 <= loop_ub; i2++) {
      ...
      r1->size[0] = 1;
      r1->size[1] = diviner_data_jd_arr->size[1];
      emxEnsureCapacity_boolean_T(sp, r1, i2, &nc_emlrtRTEI);
      loop_ub = diviner_data_jd_arr->size[0] * diviner_data_jd_arr->size[1];
      for (i2 = 0; i2 < loop_ub; i2++) {
      ...
      r2->size[0] = 1;
      r2->size[1] = loop_ub;
      emxEnsureCapacity_int32_T(sp, r2, i2, &oc_emlrtRTEI);
      loop_ub = 0;
      for (b_i = 0; b_i <= end; b_i++) {
        if (r->data[b_i] && r1->data[b_i]) {
      ...
      r3->size[0] = 1;
      r3->size[1] = loop_ub;
      emxEnsureCapacity_int32_T(sp, r3, i2, &oc_emlrtRTEI);
      loop_ub = 0;
      for (b_i = 0; b_i <= end; b_i++) {
        if (r->data[b_i] && r1->data[b_i]) {
      ...
      r4->size[0] = 1;
      r4->size[1] = loop_ub;
      emxEnsureCapacity_int32_T(sp, r4, i2, &oc_emlrtRTEI);
      loop_ub = 0;
      for (b_i = 0; b_i <= end; b_i++) {
        if (r->data[b_i] && r1->data[b_i]) {
      ...
      emxEnsureCapacity_real_T(sp, sample_timepoints->data[lat_idx +
        sample_timepoints->size[0] * long_idx].f1, i2, &pc_emlrtRTEI);
      if (lat_idx > sample_timepoints->size[0] - 1) {
        emlrtDynamicBoundsCheckR2012b(lat_idx, 0, sample_timepoints->size[0] - 1,
          &vc_emlrtBCI, sp);
      }
      ...
      r5->size[0] = 1;
      r5->size[1] = loop_ub;
      emxEnsureCapacity_int32_T(sp, r5, i2, &oc_emlrtRTEI);
      loop_ub = 0;
      for (b_i = 0; b_i <= end; b_i++) {
        if (r->data[b_i] && r1->data[b_i]) {
      ...
      emxEnsureCapacity_real_T(sp, sample_surface_temperatures->data[lat_idx +
        sample_surface_temperatures->size[0] * long_idx].f1, i2, &qc_emlrtRTEI);
      if (lat_idx > sample_surface_temperatures->size[0] - 1) {
        emlrtDynamicBoundsCheckR2012b(lat_idx, 0,
          sample_surface_temperatures->size[0] - 1, &xc_emlrtBCI, sp);
      }
