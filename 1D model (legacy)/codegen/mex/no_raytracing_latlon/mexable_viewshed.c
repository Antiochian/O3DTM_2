...
static emlrtRTEInfo ad_emlrtRTEI = { 12,/* lineNo */
  1,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo ed_emlrtRTEI = { 15,/* lineNo */
  1,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo gd_emlrtRTEI = { 19,/* lineNo */
  8,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo id_emlrtRTEI = { 193,/* lineNo */
  39,                                  /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo ld_emlrtRTEI = { 15,/* lineNo */
  13,                                  /* colNo */
  "isnan",                             /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\isnan.m"/* pName */
};

static emlrtRTEInfo md_emlrtRTEI = { 36,/* lineNo */
  5,                                   /* colNo */
  "find",                              /* fName */
...
static emlrtRTEInfo td_emlrtRTEI = { 44,/* lineNo */
  8,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo vd_emlrtRTEI = { 113,/* lineNo */
  18,                                  /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo ae_emlrtRTEI = { 81,/* lineNo */
  42,                                  /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo ce_emlrtRTEI = { 93,/* lineNo */
  8,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo de_emlrtRTEI = { 94,/* lineNo */
  3,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo fe_emlrtRTEI = { 191,/* lineNo */
  9,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo ge_emlrtRTEI = { 180,/* lineNo */
  9,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo he_emlrtRTEI = { 65,/* lineNo */
  13,                                  /* colNo */
...
static emlrtRTEInfo je_emlrtRTEI = { 74,/* lineNo */
  1,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo ke_emlrtRTEI = { 75,/* lineNo */
  1,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
...
static emlrtRTEInfo ne_emlrtRTEI = { 84,/* lineNo */
  1,                                   /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};

static emlrtRTEInfo oe_emlrtRTEI = { 1,/* lineNo */
  23,                                  /* colNo */
...
static emlrtRTEInfo nh_emlrtRTEI = { 183,/* lineNo */
  16,                                  /* colNo */
  "mexable_viewshed",                  /* fName */
  "\\\\rivendell.physics.ox.ac.uk\\user\\students\\2017\\trin3161\\Documents\\O3DTM_stripped_down\\raw_mexable_files\\mexable_viewshed.m"/* pName */
};
  ...
  pR_NorthPoleLatitude, const emxArray_real_T *yi, emxArray_real_T *lat)
{
  ...
  emxEnsureCapacity_real_T(sp, lat, i, &mh_emlrtRTEI);
  loop_ub = yi->size[0];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_int32_T(sp, &r, 1, &fe_emlrtRTEI, true);
  i = r->size[0];
  r->size[0] = loop_ub;
  emxEnsureCapacity_int32_T(sp, r, i, &nh_emlrtRTEI);
  loop_ub = 0;
  for (i = 0; i <= end; i++) {
    if (yi->data[i] == yIntrinsicLimits1) {
      r->data[loop_ub] = i + 1;
  ...
  emxEnsureCapacity_boolean_T(sp, r1, i, &hd_emlrtRTEI);
  loop_ub = lat->size[0];
  for (i = 0; i < loop_ub; i++) {
    r1->data[i] = (lat->data[i] < -pR_NorthPoleLatitude);
  }

  emxInit_boolean_T(sp, &r2, 1, &nh_emlrtRTEI, true);
  i = r2->size[0];
  r2->size[0] = lat->size[0];
  emxEnsureCapacity_boolean_T(sp, r2, i, &id_emlrtRTEI);
  loop_ub = lat->size[0];
  for (i = 0; i < loop_ub; i++) {
                      ...
                      *public_raster_struct, emxArray_real_T *vismap)
{
  ...
  emxEnsureCapacity_real_T(sp, vismap, i, &ad_emlrtRTEI);
  loop_ub = Z->size[0] * Z->size[1];
  for (i = 0; i < loop_ub; i++) {
    vismap->data[i] = rtNaN;
  }

  emxInit_real_T(sp, &y2, 2, &ed_emlrtRTEI, true);
  emxInit_real_T(sp, &lon2, 2, &jd_emlrtRTEI, true);
  if (Z->size[1] < 1) {
    lon2->size[0] = 1;
    lon2->size[1] = 0;
    y2->size[0] = 1;
    ...
    emxEnsureCapacity_real_T(sp, lon2, i, &bd_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, y2, i, &bd_emlrtRTEI);
    loop_ub = (int32_T)((real_T)Z->size[1] - 1.0);
    for (i = 0; i <= loop_ub; i++) {
  ...
  if (Z->size[0] - 1 < 2) {
    ...
    emxEnsureCapacity_real_T(sp, lon2, i, &dd_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, y2, i, &ed_emlrtRTEI);
  loop_ub = lon2->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(sp, &lat2, 2, &fd_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T(&st, lat2, i, &fd_emlrtRTEI);
  ...
  emxEnsureCapacity_int32_T(&st, r, i, &gd_emlrtRTEI);
  unnamed_idx_1 = 0;
  for (loop_ub = 0; loop_ub <= b_unnamed_idx_1; loop_ub++) {
    if (y2->data[loop_ub] == yIntrinsicLimits1) {
  ...
  emxFree_int32_T(&r);
  emxInit_boolean_T(&st, &r1, 2, &ee_emlrtRTEI, true);
  i = r1->size[0] * r1->size[1];
  r1->size[0] = 1;
  r1->size[1] = lat2->size[1];
  emxEnsureCapacity_boolean_T(&st, r1, i, &hd_emlrtRTEI);
  loop_ub = lat2->size[0] * lat2->size[1];
  for (i = 0; i < loop_ub; i++) {
    r1->data[i] = (lat2->data[i] < -public_raster_struct->NorthPoleLatitude);
  }

  emxInit_boolean_T(&st, &r2, 2, &ee_emlrtRTEI, true);
  i = r2->size[0] * r2->size[1];
  r2->size[0] = 1;
  r2->size[1] = lat2->size[1];
  emxEnsureCapacity_boolean_T(&st, r2, i, &id_emlrtRTEI);
  loop_ub = lat2->size[0] * lat2->size[1];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&st, lon2, i, &jd_emlrtRTEI);
  ...
  emxInit_int32_T(&st, &r3, 2, &ge_emlrtRTEI, true);
  i = r3->size[0] * r3->size[1];
  r3->size[0] = 1;
  r3->size[1] = unnamed_idx_1;
  emxEnsureCapacity_int32_T(&st, r3, i, &kd_emlrtRTEI);
  unnamed_idx_1 = 0;
  for (loop_ub = 0; loop_ub <= b_unnamed_idx_1; loop_ub++) {
    if (x2->data[loop_ub] == yIntrinsicLimits1) {
  ...
  emxFree_int32_T(&r3);
  i = lat2->size[1];
  emxInit_int32_T(sp, &ii, 1, &ee_emlrtRTEI, true);
  emxInit_real_T(sp, &lontrk, 1, &ee_emlrtRTEI, true);
  emxInit_real_T(sp, &arclenInRadians, 1, &he_emlrtRTEI, true);
  emxInit_boolean_T(sp, &vis0, 1, &ee_emlrtRTEI, true);
  emxInit_real_T(sp, &z1, 2, &ee_emlrtRTEI, true);
  emxInit_real_T(sp, &z2, 2, &ee_emlrtRTEI, true);
  emxInit_boolean_T(sp, &qNaN, 1, &ie_emlrtRTEI, true);
  emxInit_real_T(sp, &xi, 1, &je_emlrtRTEI, true);
  emxInit_real_T(sp, &yi, 1, &ke_emlrtRTEI, true);
  emxInit_boolean_T(sp, &qOutside, 1, &le_emlrtRTEI, true);
  emxInit_real_T(sp, &c, 1, &me_emlrtRTEI, true);
  emxInit_real_T(sp, &b_r, 1, &ne_emlrtRTEI, true);
  emxInit_boolean_T(sp, &r4, 1, &ee_emlrtRTEI, true);
  for (k = 0; k < i; k++) {
    st.site = &kb_emlrtRSI;
    b_unnamed_idx_1 = k + 1;
    ...
    emxEnsureCapacity_boolean_T(&st, qNaN, b_unnamed_idx_1, &qd_emlrtRTEI);
    loop_ub = yi->size[0];
    for (b_unnamed_idx_1 = 0; b_unnamed_idx_1 < loop_ub; b_unnamed_idx_1++) {
    ...
    emxEnsureCapacity_boolean_T(&st, r4, b_unnamed_idx_1, &rd_emlrtRTEI);
    ...
    b_unnamed_idx_1 = r4->size[0];
    r4->size[0] = yi->size[0];
    emxEnsureCapacity_boolean_T(&b_st, r4, b_unnamed_idx_1, &ud_emlrtRTEI);
    loop_ub = yi->size[0];
    b_unnamed_idx_1 = qOutside->size[0];
    qOutside->size[0] = yi->size[0];
    emxEnsureCapacity_boolean_T(&b_st, qOutside, b_unnamed_idx_1, &vd_emlrtRTEI);
    for (b_unnamed_idx_1 = 0; b_unnamed_idx_1 < loop_ub; b_unnamed_idx_1++) {
    ...
    emxEnsureCapacity_boolean_T(&st, qOutside, b_unnamed_idx_1, &wd_emlrtRTEI);
    loop_ub = xi->size[0];
    b_unnamed_idx_1 = r4->size[0];
    r4->size[0] = xi->size[0];
    ...
    b_unnamed_idx_1 = r4->size[0];
    r4->size[0] = yi->size[0];
    emxEnsureCapacity_boolean_T(&st, r4, b_unnamed_idx_1, &ae_emlrtRTEI);
    loop_ub = yi->size[0];
    for (b_unnamed_idx_1 = 0; b_unnamed_idx_1 < loop_ub; b_unnamed_idx_1++) {
    ...
    c->size[0] = xi->size[0];
    emxEnsureCapacity_real_T(&f_st, c, unnamed_idx_1, &be_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(&f_st, b_r, unnamed_idx_1, &be_emlrtRTEI);
    g_st.site = &qc_emlrtRSI;
    h_st.site = &uc_emlrtRSI;
    ...
    b_unnamed_idx_1 = xi->size[0];
    xi->size[0] = c->size[0];
    emxEnsureCapacity_real_T(&st, xi, b_unnamed_idx_1, &ce_emlrtRTEI);
    for (b_unnamed_idx_1 = 0; b_unnamed_idx_1 < loop_ub; b_unnamed_idx_1++) {
    ...
    ii->size[0] = xi->size[0];
    emxEnsureCapacity_int32_T(&st, ii, b_unnamed_idx_1, &de_emlrtRTEI);
    loop_ub = xi->size[0];
    for (b_unnamed_idx_1 = 0; b_unnamed_idx_1 < loop_ub; b_unnamed_idx_1++) {
  ...
  emxFree_real_T(&lon2);
  emxFree_real_T(&lat2);
  emxInit_boolean_T(sp, &r5, 2, &ld_emlrtRTEI, true);
  ...
  emxEnsureCapacity_boolean_T(&st, r5, i, &ld_emlrtRTEI);
  loop_ub = vismap->size[0] * vismap->size[1];
  for (i = 0; i < loop_ub; i++) {
    r5->data[i] = muDoubleScalarIsNaN(vismap->data[i]);
  }

  emxInit_int32_T(&st, &jj, 1, &ee_emlrtRTEI, true);
  b_st.site = &te_emlrtRSI;
  eml_find(&b_st, r5, ii, jj);
  i = xi->size[0];
  xi->size[0] = ii->size[0];
  emxEnsureCapacity_real_T(&st, xi, i, &md_emlrtRTEI);
  loop_ub = ii->size[0];
  ...
  i = yi->size[0];
  yi->size[0] = jj->size[0];
  emxEnsureCapacity_real_T(&st, yi, i, &nd_emlrtRTEI);
  loop_ub = jj->size[0];
  for (i = 0; i < loop_ub; i++) {
    yi->data[i] = jj->data[i];
  }
  ...
  emxEnsureCapacity_real_T(&st, b_r, i, &od_emlrtRTEI);
  loop_ub = xi->size[0];
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_int32_T(&st, &r6, 1, &ge_emlrtRTEI, true);
  i = r6->size[0];
  r6->size[0] = unnamed_idx_1;
  emxEnsureCapacity_int32_T(&st, r6, i, &pd_emlrtRTEI);
  unnamed_idx_1 = 0;
  for (loop_ub = 0; loop_ub <= b_unnamed_idx_1; loop_ub++) {
    if (xi->data[loop_ub] == yIntrinsicLimits1) {
  ...
  emxEnsureCapacity_boolean_T(sp, qNaN, i, &sd_emlrtRTEI);
  loop_ub = xi->size[0];
  for (i = 0; i < loop_ub; i++) {
    qNaN->data[i] = false;
  }
  ...
  i = xi->size[0];
  emxInit_real_T(sp, &lattrk, 1, &ee_emlrtRTEI, true);
  emxInit_real_T(sp, &h, 1, &oe_emlrtRTEI, true);
  for (k = 0; k < i; k++) {
    st.site = &pb_emlrtRSI;
    b_unnamed_idx_1 = k + 1;
  ...
  i = ii->size[0];
  ii->size[0] = yi->size[0];
  emxEnsureCapacity_int32_T(sp, ii, i, &td_emlrtRTEI);
  loop_ub = yi->size[0];
  for (i = 0; i < loop_ub; i++) {
