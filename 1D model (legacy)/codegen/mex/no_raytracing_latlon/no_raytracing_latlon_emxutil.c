 ...
 *
 * no_raytracing_latlon_emxutil.c
 *
 * Code generation for function 'no_raytracing_latlon_emxutil'
 *
 */
...
void emxInitStruct_struct_T1(const emlrtStack *sp, b_struct_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->Kc_3dmat_local, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->rho_matrix_local, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->vis_flux_local, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->ir_flux_local, 2, srcLocation, doPush);
}

void emxInitStruct_struct_T2(const emlrtStack *sp, c_struct_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->h_arr_local, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->decl_arr_local, 2, srcLocation, doPush);
}
...
/* End of code generation (no_raytracing_latlon_emxutil.c) */
