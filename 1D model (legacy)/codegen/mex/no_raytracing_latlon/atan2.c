             ...
             emxArray_real_T *x, emxArray_real_T *r)
{
  ...
  emxInit_real_T(sp, &z, 2, &be_emlrtRTEI, true);
  st.site = &oc_emlrtRSI;
  ...
  emxEnsureCapacity_real_T(&b_st, z, k, &ye_emlrtRTEI);
  if (!b_dimagree(z, y, x)) {
    emlrtErrorWithMessageIdR2018a(&b_st, &k_emlrtRTEI, "MATLAB:dimagree",
      "MATLAB:dimagree", 0);
  }
  ...
  r->size[0] = 1;
  r->size[1] = csz_idx_1;
  emxEnsureCapacity_real_T(&st, r, k, &be_emlrtRTEI);
