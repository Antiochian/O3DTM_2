...
static emlrtRTEInfo w_emlrtRTEI = { 85,/* lineNo */
  27,                                  /* colNo */
...
static emlrtRTEInfo qh_emlrtRTEI = { 17,/* lineNo */
  9,                                   /* colNo */
                      ...
                      emxArray_boolean_T *idx)
{
  ...
  if (k > x->size[0]) {
    emlrtErrorWithMessageIdR2018a(&st, &w_emlrtRTEI, "MATLAB:subsdeldimmismatch",
  ...
  emxEnsureCapacity_boolean_T(&st, x, nxin, &qh_emlrtRTEI);
}
                    ...
                    emxArray_boolean_T *idx)
{
  ...
  emxEnsureCapacity_real_T(&st, x, nxin, &qh_emlrtRTEI);
}
