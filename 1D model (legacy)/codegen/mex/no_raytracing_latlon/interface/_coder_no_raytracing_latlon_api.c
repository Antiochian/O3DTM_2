 ...
 *
 * _coder_no_raytracing_latlon_api.c
 *
 * Code generation for function '_coder_no_raytracing_latlon_api'
 *
 */
...
static emlrtRTEInfo ph_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_no_raytracing_latlon_api",   /* fName */
  ""                                   /* pName */
};
...
void no_raytracing_latlon_api(const mxArray * const prhs[21], int32_T nlhs,
  const mxArray *plhs[4])
{
  ...
  emxInit_real_T(&st, &z_arr, 2, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &rho_matrix, 3, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &lat_arr, 2, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &long_arr, 2, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &dz_arr, 2, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &init_temps, 2, &ph_emlrtRTEI, true);
  emxInitStruct_struct1_T(&st, &raytracing_params, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &ew_matrix, 2, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &ns_matrix, 2, &ph_emlrtRTEI, true);
  emxInitStruct_struct4_T(&st, &diviner_data, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &Tmax_3dmat, 3, &ph_emlrtRTEI, true);
  emxInit_real_T(&st, &Tmin_3dmat, 3, &ph_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &sample_timepoints, 2, &ph_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &T_error_3dmat, 2, &ph_emlrtRTEI, true);
  ...
  no_raytracing_latlon(&st, z_arr, bottom_layer_idx, depth_update_wait_t,
                       ...
                       Tmin_3dmat, sample_timepoints, T_error_3dmat);
  ...
  if (nlhs > 2) {
    plhs[2] = h_emlrt_marshallOut(sample_timepoints);
  }
...
/* End of code generation (_coder_no_raytracing_latlon_api.c) */
