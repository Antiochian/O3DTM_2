              ...
              emxArray_int32_T *i, emxArray_int32_T *j)
{
  ...
  if (nx == 0) {
    ...
    emxInit_boolean_T(sp, &v, 1, &kh_emlrtRTEI, true);
    st.site = &ue_emlrtRSI;
    idx = 0;
    jj = i->size[0];
    i->size[0] = nx;
    emxEnsureCapacity_int32_T(&st, i, jj, &fh_emlrtRTEI);
    jj = j->size[0];
    j->size[0] = nx;
    emxEnsureCapacity_int32_T(&st, j, jj, &gh_emlrtRTEI);
    jj = v->size[0];
    v->size[0] = nx;
    emxEnsureCapacity_boolean_T(&st, v, jj, &hh_emlrtRTEI);
    ii = 1;
    jj = 1;
    exitg1 = false;
    ...
    if (nx == 1) {
      ...
      ii = i->size[0];
      i->size[0] = jj;
      emxEnsureCapacity_int32_T(&st, i, ii, &ih_emlrtRTEI);
      if (1 > idx) {
        jj = 0;
      } else {
        jj = idx;
      ...
      ii = j->size[0];
      j->size[0] = jj;
      emxEnsureCapacity_int32_T(&st, j, ii, &jh_emlrtRTEI);
      iv[0] = 1;
      if (1 > idx) {
        iv[1] = 0;
      } else {
