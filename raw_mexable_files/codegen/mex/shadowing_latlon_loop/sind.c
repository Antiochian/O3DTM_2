...
static emlrtRSInfo xf_emlrtRSI = { 10, /* lineNo */
  "sind",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elfun\\sind.m"/* pathName */
};
...
void c_sind(const emlrtStack *sp, emxArray_real_T *x)
{
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack st;
