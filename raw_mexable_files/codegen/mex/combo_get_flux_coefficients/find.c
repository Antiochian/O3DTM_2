...
static emlrtRSInfo sd_emlrtRSI = { 253,/* lineNo */
  "find_first_nonempty_triples",       /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pathName */
};

static emlrtRSInfo td_emlrtRSI = { 254,/* lineNo */
  "find_first_nonempty_triples",       /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pathName */
};

static emlrtRSInfo ud_emlrtRSI = { 255,/* lineNo */
  "find_first_nonempty_triples",       /* fcnName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pathName */
};
...
static emlrtRTEInfo gf_emlrtRTEI = { 195,/* lineNo */
  24,                                  /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};

static emlrtRTEInfo hf_emlrtRTEI = { 197,/* lineNo */
  24,                                  /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};

static emlrtRTEInfo if_emlrtRTEI = { 199,/* lineNo */
  24,                                  /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};

static emlrtRTEInfo jf_emlrtRTEI = { 253,/* lineNo */
  5,                                   /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};

static emlrtRTEInfo kf_emlrtRTEI = { 254,/* lineNo */
  5,                                   /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};

static emlrtRTEInfo lf_emlrtRTEI = { 45,/* lineNo */
  20,                                  /* colNo */
  "find",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m"/* pName */
};
              ...
              emxArray_int32_T *i, emxArray_int32_T *j)
{
  ...
  if (nx == 0) {
    ...
    emxInit_boolean_T(sp, &v, 1, &lf_emlrtRTEI, true);
    st.site = &qd_emlrtRSI;
    idx = 0;
    jj = i->size[0];
    i->size[0] = nx;
    emxEnsureCapacity_int32_T(&st, i, jj, &gf_emlrtRTEI);
    jj = j->size[0];
    j->size[0] = nx;
    emxEnsureCapacity_int32_T(&st, j, jj, &hf_emlrtRTEI);
    jj = v->size[0];
    v->size[0] = nx;
    emxEnsureCapacity_boolean_T(&st, v, jj, &if_emlrtRTEI);
    ii = 1;
    jj = 1;
    exitg1 = false;
    ...
    if (nx == 1) {
      ...
      ii = i->size[0];
      i->size[0] = jj;
      emxEnsureCapacity_int32_T(&st, i, ii, &jf_emlrtRTEI);
      if (1 > idx) {
        jj = 0;
      } else {
        jj = idx;
      ...
      ii = j->size[0];
      j->size[0] = jj;
      emxEnsureCapacity_int32_T(&st, j, ii, &kf_emlrtRTEI);
      iv[0] = 1;
      if (1 > idx) {
        iv[1] = 0;
      } else {
