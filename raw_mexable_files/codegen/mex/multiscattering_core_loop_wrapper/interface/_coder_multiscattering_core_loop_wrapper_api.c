 ...
 *
 * _coder_multiscattering_core_loop_wrapper_api.c
 *
 * Code generation for function '_coder_multiscattering_core_loop_wrapper_api'
 *
 */
...
static emlrtRTEInfo fg_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_multiscattering_core_loop_wrapper_api",/* fName */
  ""                                   /* pName */
};
...
static void f_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, emxArray_real_T *y);
static creal_T fb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *vis_flux_matrix, const char_T *identifier, emxArray_real_T *y);
...
static boolean_T hb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void i_emlrt_marshallIn(const emlrtStack *sp, const mxArray *parameters,
...
static const mxArray *j_emlrt_marshallOut(const emxArray_cell_wrap_0 *u);
static void jb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, char_T ret[4]);
static datetime k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  ...
  *recent_only, const char_T *identifier)
{
  ...
  y = n_emlrt_marshallIn(sp, emlrtAlias(recent_only), &thisId);
  ...
  *vis_flux_matrix, const char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  h_emlrt_marshallIn(sp, emlrtAlias(vis_flux_matrix), &thisId, y);
  emlrtDestroyArray(&vis_flux_matrix);
}
  ...
  const char_T *identifier, struct0_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  j_emlrt_marshallIn(sp, emlrtAlias(parameters), &thisId, y);
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  y->phase_start_dtm = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp,
    u, 0, 20, "phase_start_dtm")), &thisId);
  thisId.fIdentifier = "phase_end_dtm";
  y->phase_end_dtm = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u,
    0, 21, "phase_end_dtm")), &thisId);
  thisId.fIdentifier = "diviner_start_dtm";
  y->diviner_start_dtm = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b
    (sp, u, 0, 22, "diviner_start_dtm")), &thisId);
  thisId.fIdentifier = "diviner_end_dtm";
  y->diviner_end_dtm = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp,
  ...
  y->live_graph = n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0,
  ...
  y->show_results_table = n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b
    (sp, u, 0, 39, "show_results_table")), &thisId);
  thisId.fIdentifier = "return_z_grid";
  y->return_z_grid = n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u,
    0, 40, "return_z_grid")), &thisId);
  thisId.fIdentifier = "return_T_arr";
  y->return_T_arr = n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u,
  ...
  y->parameter_generation_datetime = k_emlrt_marshallIn(sp, emlrtAlias
  ...
  emlrtMsgIdentifier *parentId)
{
  ...
  y.data = l_emlrt_marshallIn(sp, emlrtAlias(propValues[0]), &thisId);
  thisId.fIdentifier = "fmt";
  m_emlrt_marshallIn(sp, emlrtAlias(propValues[1]), &thisId);
  thisId.fIdentifier = "tz";
  m_emlrt_marshallIn(sp, emlrtAlias(propValues[2]), &thisId);
...
void d_multiscattering_core_loop_wra(const mxArray * const prhs[21], int32_T
  nlhs, const mxArray *plhs[4])
{
  ...
  emxInit_real_T(&st, &z_arr, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &rho_matrix, 3, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &lat_arr, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &long_arr, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &vis_flux_matrix, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &ir_flux_matrix, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &dz_arr, 2, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &init_temps, 2, &fg_emlrtRTEI, true);
  emxInitStruct_struct1_T(&st, &raytracing_params, &fg_emlrtRTEI, true);
  emxInitStruct_struct4_T(&st, &diviner_data, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &Tmax_3dmat, 3, &fg_emlrtRTEI, true);
  emxInit_real_T(&st, &Tmin_3dmat, 3, &fg_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &sample_timepoints, 2, &fg_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &T_error_3dmat, 2, &fg_emlrtRTEI, true);
  ...
  vis_flux_matrix->canFreeData = false;
  g_emlrt_marshallIn(&st, emlrtAlias(prhs[10]), "vis_flux_matrix",
                     vis_flux_matrix);
  ir_flux_matrix->canFreeData = false;
  g_emlrt_marshallIn(&st, emlrtAlias(prhs[11]), "ir_flux_matrix", ir_flux_matrix);
  dz_arr->canFreeData = false;
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[12]), "dz_arr", dz_arr);
  dz = emlrt_marshallIn(&st, emlrtAliasP(prhs[13]), "dz");
  i_emlrt_marshallIn(&st, emlrtAliasP(prhs[14]), "parameters", &parameters);
  init_temps->canFreeData = false;
  g_emlrt_marshallIn(&st, emlrtAlias(prhs[15]), "init_temps", init_temps);
  o_emlrt_marshallIn(&st, emlrtAliasP(prhs[16]), "raytracing_params",
                     &raytracing_params);
  ...
  multiscattering_core_loop_wrapper(&st, z_arr, bottom_layer_idx,
    depth_update_wait_t, depth_update_t_interval, num_layers, t_limit, t_wait,
    rho_matrix, lat_arr, long_arr, vis_flux_matrix, ir_flux_matrix, dz_arr, dz,
    &parameters, init_temps, &raytracing_params, start_jd, end_jd, &diviner_data,
    recent_only, Tmax_3dmat, Tmin_3dmat, sample_timepoints, T_error_3dmat);

  /* Marshall function outputs */
  Tmax_3dmat->canFreeData = false;
  plhs[0] = i_emlrt_marshallOut(Tmax_3dmat);
  ...
  emxFree_real_T(&ir_flux_matrix);
  emxFree_real_T(&vis_flux_matrix);
  ...
  if (nlhs > 1) {
    ...
    plhs[1] = i_emlrt_marshallOut(Tmin_3dmat);
  }

  emxFree_real_T(&Tmin_3dmat);
  if (nlhs > 2) {
    plhs[2] = j_emlrt_marshallOut(sample_timepoints);
  }

  emxFree_cell_wrap_0(&sample_timepoints);
  if (nlhs > 3) {
    plhs[3] = j_emlrt_marshallOut(T_error_3dmat);
  }
...
/* End of code generation (_coder_multiscattering_core_loop_wrapper_api.c) */
