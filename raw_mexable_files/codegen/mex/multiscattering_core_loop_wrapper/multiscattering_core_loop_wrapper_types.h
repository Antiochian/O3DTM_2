 ...
 *
 * multiscattering_core_loop_wrapper_types.h
 *
...
typedef struct {
  ...
  real_T c3;
  real_T c4;
  emxArray_real_T *A0_nx1;
  emxArray_real_T *a_OVER_pi_OVER_4_POWER_3_nx1;
  emxArray_real_T *b_OVER_pi_OVER_2_POWER_8_nx1;
...
/* End of code generation (multiscattering_core_loop_wrapper_types.h) */
