 ...
 *
 * multiscattering_core_loop_wrapper_emxutil.c
 *
 * Code generation for function 'multiscattering_core_loop_wrapper_emxutil'
 *
 */
...
void emxFreeStruct_struct_T(struct_T *pStruct)
{
  ...
  emxFree_real_T(&pStruct->A0_nx1);
  emxFree_real_T(&pStruct->a_OVER_pi_OVER_4_POWER_3_nx1);
  emxFree_real_T(&pStruct->b_OVER_pi_OVER_2_POWER_8_nx1);
  emxFree_real_T(&pStruct->thermal_emission_matrix);
  emxFree_real_T(&pStruct->B_surface_matrix);
  emxFree_real_T(&pStruct->Kc_3dmat);
}
...
void emxInitStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->slope_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->aspect_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->elevation_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->extended_elevation_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->h_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->decl_arr, 2, srcLocation, doPush);
}

void emxInitStruct_struct4_T(const emlrtStack *sp, struct4_T *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->lat_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->long_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->T_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->jd_arr, 2, srcLocation, doPush);
}
...
{
  emxInit_real_T(sp, &pStruct->t_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->p_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->q_arr, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->A0_nx1, 1, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->a_OVER_pi_OVER_4_POWER_3_nx1, 1, srcLocation,
                 doPush);
  emxInit_real_T(sp, &pStruct->b_OVER_pi_OVER_2_POWER_8_nx1, 1, srcLocation,
                 doPush);
  emxInit_real_T(sp, &pStruct->thermal_emission_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->B_surface_matrix, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->Kc_3dmat, 3, srcLocation, doPush);
}
...
/* End of code generation (multiscattering_core_loop_wrapper_emxutil.c) */
