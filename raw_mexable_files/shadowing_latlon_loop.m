...
B_surface_matrix = zeros(numel(lat_arr), numel(long_arr));
...
%         long = long_arr(long_idx);
        ...
        %% TIME LOOP
        [Tmin_local, Tmax_local, jd_error_local, T_error_local] = shadowing_timeloop(T_arr, dz_arr, temperature_parameters,local_temperature_params, raytracing_params, local_raytracing_params, lat, long, sample_timepoints_local, sample_surface_temperatures_local);
